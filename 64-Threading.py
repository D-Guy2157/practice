...
print(time.perf_counter() - start)  # this was supposed to work with just time.perf_counter() but for some reason
#                                     its jank and I had to use - start and the variable above
